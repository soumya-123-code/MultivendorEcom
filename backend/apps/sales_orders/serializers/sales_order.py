...
class SalesOrderListSerializer(serializers.ModelSerializer):
    ...
    vendor_orders_count = serializers.SerializerMethodField()
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_multi_vendor', 'vendor_count', 'vendor_orders_count',
    ...
    def get_vendor_orders_count(self, obj):
        return obj.vendor_orders.count() if hasattr(obj, 'vendor_orders') else 0
...
class SalesOrderDetailSerializer(SalesOrderSerializer):
    """Extended detail serializer with vendor orders."""
    vendor_orders = serializers.SerializerMethodField()

    class Meta(SalesOrderSerializer.Meta):
        fields = SalesOrderSerializer.Meta.fields + ['vendor_orders', 'coupon']

    def get_vendor_orders(self, obj):
        from apps.sales_orders.serializers.vendor_order import VendorOrderListSerializer
        return VendorOrderListSerializer(obj.vendor_orders.all(), many=True).data
